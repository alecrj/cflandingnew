    ...
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <section className="px-6 py-32 max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          <button className="bg-[#0066FF] hover:bg-[#0052CC] text-white px-10 py-5 rounded-lg text-lg font-bold transition flex items-center justify-center gap-2 shadow-lg">
            Start Free 14-Day Trial
            <ArrowRight className="w-5 h-5" />
          </button>
          <a
            href="tel:5551234822"
            className="bg-transparent border-2 border-[#0066FF] text-[#0066FF] hover:bg-[#0066FF] hover:text-white px-10 py-5 rounded-lg text-lg font-bold transition flex items-center justify-center gap-2"
          >
        ...
        <p className="text-sm text-gray-500">No credit card • Cancel anytime • Setup in 5 minutes</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-4xl mx-auto">
          <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
            <div className="text-4xl font-bold mb-2 text-[#0066FF]">100%</div>
            <div className="text-gray-300 font-medium">Calls Answered</div>
            <div className="text-sm text-gray-500 mt-1">Never miss another lead</div>
          </div>
          <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
            <div className="text-4xl font-bold mb-2 text-[#0066FF]">&lt;2 sec</div>
            <div className="text-gray-300 font-medium">Response Time</div>
            <div className="text-sm text-gray-500 mt-1">Faster than any human</div>
          </div>
          <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
            <div className="text-4xl font-bold mb-2 text-[#0066FF]">24/7</div>
            <div className="text-gray-300 font-medium">Always Available</div>
            <div className="text-sm text-gray-500 mt-1">Nights, weekends, holidays</div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24 bg-[#0F172A]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-16 text-lg">Built specifically for HVAC businesses</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-[#0066FF] w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6">
                1
              </div>
              <h3 className="text-2xl font-bold mb-4">Forward Your Calls</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold mb-4">Start Capturing Leads</h3>
              <p className="text-gray-400 leading-relaxed">
          ...
          <div className="mt-16 text-center">
            <button className="bg-[#0066FF] hover:bg-[#0052CC] text-white px-12 py-5 rounded-lg text-lg font-bold transition inline-flex items-center gap-2 shadow-lg">
              Get Started Now
              <ArrowRight className="w-5 h-5" />
            </button>
      ...
      <section className="px-6 py-24 bg-[#0F172A]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* Lost Call Scenarios */}
            <div className="bg-red-900/10 border-2 border-red-800/50 rounded-xl p-8">
              <div className="flex items-start gap-4 mb-6">
                <div className="bg-red-500/20 p-3 rounded-lg">
                  <XCircle className="w-8 h-8 text-red-400" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-red-400 mb-2">40% of Calls After 5 PM</h3>
                  <p className="text-gray-300">Emergency HVAC calls happen at night and weekends—exactly when you can't answer.</p>
                </div>
              </div>
              <div className="text-sm text-gray-400 bg-red-950/30 rounded-lg p-4">
            ...
            <div className="bg-red-900/10 border-2 border-red-800/50 rounded-xl p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-red-400 mb-2">$2,500 Average Emergency Call</h3>
                  <p className="text-gray-300">AC replacements, furnace repairs, emergency service—these are your most profitable jobs.</p>
                </div>
              </div>
              <div className="text-sm text-gray-400 bg-red-950/30 rounded-lg p-4">
          ...
          <div className="bg-[#1E293B] border-2 border-gray-700 rounded-xl p-8 max-w-3xl mx-auto text-center">
      ...
      <section className="px-6 py-24 bg-[#1A1F2E]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#0F172A] border-2 border-[#0066FF] rounded-2xl p-8 md:p-12">
            {/* Calculator Inputs */}
            <div className="space-y-8 mb-12">
              {/* Slider 1: Average Service Ticket */}
              <div>
                <div className="flex justify-between items-center mb-4">
                  <label className="text-lg font-semibold text-white">Average Service Ticket Value</label>
                  <span className="text-2xl font-bold text-[#0066FF]">${ticketValue.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  min="500"
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <label className="text-lg font-semibold text-white">Missed Calls Per Week</label>
                  <span className="text-2xl font-bold text-[#0066FF]">{missedCallsPerWeek}</span>
                </div>
                <input
                  type="range"
                  min="1"
            ...
            {/* Results */}
            <div className="bg-gradient-to-br from-red-900/20 to-red-800/10 border-2 border-red-500/50 rounded-xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-center mb-8 text-white">You're Losing:</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">Per Week</div>
                  <div className="text-3xl font-bold text-red-400">${weeklyLost.toLocaleString()}</div>
                </div>
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">Per Month</div>
                  <div className="text-3xl font-bold text-red-400">${monthlyLost.toLocaleString()}</div>
                </div>
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">Per Year</div>
                  <div className="text-4xl md:text-5xl font-bold text-red-400">${annualLost.toLocaleString()}</div>
                </div>
              </div>
            </div>

            {/* Savings with ClientFlow */}
            <div className="bg-gradient-to-br from-green-900/20 to-green-800/10 border-2 border-green-500/50 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-center mb-6 text-white">With ClientFlow Professional ($597/mo):</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">Annual Revenue Captured</div>
                  <div className="text-4xl font-bold text-green-400">${annualLost.toLocaleString()}</div>
                </div>
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">Net Savings (After ClientFlow Cost)</div>
                  <div className="text-4xl font-bold text-green-400">${annualSavings.toLocaleString()}</div>
                </div>
              </div>
              <div className="mt-8 pt-8 border-t border-green-500/30 text-center">
                ...
                <div className="text-6xl font-bold bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent">
                  {roi > 0 ? roi : 0}%
                </div>
      ...
      <section className="px-6 py-24 bg-[#0F172A]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {/* FAQ 1 */}
            <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold mb-3 text-white">How long does setup actually take?</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* FAQ 2 */}
            <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold mb-3 text-white">Can I keep my current phone number?</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* FAQ 3 */}
            <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold mb-3 text-white">What happens if the AI can't handle a call?</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* FAQ 4 */}
            <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold mb-3 text-white">How is this different from a traditional receptionist?</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* FAQ 6 */}
            <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-8">
              <h3 className="text-xl font-bold mb-3 text-white">Does it integrate with my calendar and CRM?</h3>
              <p className="text-gray-400 leading-relaxed">
          ...
          <div className="mt-16 text-center">
            <p className="text-lg text-gray-400 mb-6">Still have questions?</p>
            <a
              href="tel:5551234822"
              className="inline-flex items-center gap-2 text-[#0066FF] hover:text-[#0052CC] font-semibold text-lg transition"
            >
              <Phone className="w-5 h-5" />
      ...
      {/* Final CTA */}
      <section className="px-6 py-32 bg-gradient-to-b from-[#1A1F2E] to-[#0F172A] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <button className="bg-[#0066FF] hover:bg-[#0052CC] text-white px-16 py-6 rounded-lg font-bold text-xl transition mb-8 shadow-lg inline-flex items-center gap-3">
